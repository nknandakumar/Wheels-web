...
export const SOURCES = createOptions(["Self", "Dealer", "Bank"]);
export const STAGES = createOptions(["Lead", "Cibil", "Login", "Sanction", "Rejected", "Disbursed"]);
export const PROFILE_TYPES = createOptions(["Sale Purchase", "Refinance", "Int Refinance", "BT", "Topup", "Int Topup"]);
export const GENDERS = createOptions(["Male", "Female", "Other"]);
export const CUSTOMER_PROFILES = createOptions(["Self-Employed", "Salaried", "ITR", "Agriculture"]);
...
export const RELATIONSHIPS = createOptions(["Father", "Mother", "Brother", "Spouse", "Son", "Daughter", "Sister"]);
...
export const RC_CARD_STATUSES = createOptions(["SELLER", "RTO", "WHEELS WEB", "CUSTOMER"]);
